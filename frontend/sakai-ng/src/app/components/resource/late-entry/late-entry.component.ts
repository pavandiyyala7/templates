...
@Component({
  selector: 'app-late-entry',
  templateUrl: './late-entry.component.html',
  styleUrl: './late-entry.component.scss'
})
export class LateEntryComponent implements OnInit, OnDestroy {
