...
@Component({
  selector: 'app-insufficient-hours-report',
  templateUrl: './insufficient-hours-report.component.html',
  styleUrl: './insufficient-hours-report.component.scss'
})
export class InsufficientHoursReportComponent implements OnInit, OnDestroy {
